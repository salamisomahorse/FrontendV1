...
import { registerTalent } from '@/core/services/api';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {skills.map((s) => (
                <span
                  key={s}
                  className="bg-slate-800 text-nexus-400 px-2 py-1 rounded text-sm flex items-center gap-1 border border-slate-700"
                >
                  {s}
                  <X
                    size={12}
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-slate-700 rounded-lg p-6 text-center hover:border-nexus-500 transition-colors cursor-pointer bg-slate-900">
              ...
              />
              {formData.resume && (
                <p className="text-nexus-400 text-sm mt-2">{formData.resume}</p>
              )}
            </div>
          </div>
