...
import { createProject } from '@/core/services/api';
    ...
    <div className="max-w-4xl mx-auto py-8 animate-fade-in space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                className={`w-full bg-slate-900 border rounded-lg p-3 text-white text-sm focus:ring-2 focus:ring-nexus-500 outline-none min-h-[120px] ${
        ...
        <Card className="p-6">
          ...
          {errors.requirements && (
            <p className="mb-2 text-xs text-red-400">{errors.requirements}</p>
          )}
          ...
          <div className="space-y-3">
            {requirements.map((req, index) => (
              <div
                key={index}
                className="flex flex-col md:flex-row gap-3 items-end bg-slate-900/50 p-3 rounded-lg border border-slate-800"
              >
                ...
                <div className="w-full md:w-32">
                  <Input
                    ...
                    onChange={(e) =>
                      handleRequirementChange(index, 'minExperience', e.target.value)
                    }
                  />
                </div>
